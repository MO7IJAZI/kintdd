...
export default async function DynamicProductsCategoryPage({
    params,
}: {
            ...
            <div className="container">
                        ...
                        <div style={{ display: "flex", gap: "1rem", flexWrap: "wrap" }}>
                            {category.children.map((child) => {
                                ...
                                return (
                                    <Link
                                        key={child.id}
                                        href={{ pathname: "/product-category/[slug]", params: { slug: child.slug } } as any}
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(300px, 1fr))", gap: "2rem" }}>
                    {category.products.map((product) => {
                        ...
                        return (
                            <Link key={product.id} href={{ pathname: "/product/[slug]", params: { slug: product.slug } } as any} className="card">
